...
const Contact = () => {
  ...
  // Social media links data for reusability
  const socialLinks = [
    {
      name: "Reddit",
      url: "https://www.reddit.com/user/Fun_Paper7159/",
      icon: (
    ...
    {
      name: "GitHub",
      url: "https://github.com/Aswin-Hariram",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/aswin-hariram/",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/aswin_hariram_/",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  // Contact info items for reusability
  const contactInfo = [
    {
      type: "Email",
      value: "aswincseskct@gmail.com",
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const SocialLink = useCallback(({ url, icon, name }) => (
    <a 
      href={url}
      target="_blank"
  ...
  return (
    ...
    >
      <div className="contact-container">
        <motion.div className="textContainer" variants={variants}>
          ...
          <div className="contact-info">
            {contactInfo.map((item, index) => (
              <motion.div className="item" variants={variants} key={item.type}>
        ...
        {/* Mobile social links */}
        <motion.div className="mobile-social-links" variants={variants}>
          {socialLinks.map((social) => (
            <SocialLink 
              key={social.name}
              url={social.url}
