...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const heroSectionHeight = window.innerHeight - 100; // Subtract navbar height
      ...
      <div className="wrapper">
        ...
        <div className="social">
          <motion.a
            ...
            style={{borderColor: "#0c0c1d",borderWidth: "2px",borderRadius: "50%", marginRight: "10px"}}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <motion.a
            ...
            style={{borderColor: "#0c0c1d",borderWidth: "2px",borderRadius: "50%"}}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
